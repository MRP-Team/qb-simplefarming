...
LettuceField = {
    [1] = {
        label = "Lettuce Field",
        BlipCoord = vector3(1961.88, 4870.6, 45.47),
        Blip = 1,
        BlipColor = 2,
        zones = {
			vector2(1981.6298828125, 4864.4477539062),
			vector2(1945.2867431641, 4827.8720703125),
			vector2(1925.9099121094, 4847.8305664062),
			vector2(1961.9510498047, 4884.0581054688)
        },
        minZ = 45.324493408203,
        maxZ = 45.436126708984
    },
}

PineAppleField = {
    [1] = {
        label = "PineApple Field",
        BlipCoord = vector3(368.03, 6619.66, 28.83),
        Blip = 1,
        BlipColor = 46,
        zones = {
			vector2(371.62637329102, 6592.76953125),
			vector2(363.82958984375, 6592.7529296875),
			vector2(364.51965332032, 6655.1337890625),
			vector2(372.1057434082, 6655.4697265625)			
        },
        minZ = 28.422689437866,
        maxZ = 28.698217391968
    },
}
...
Garden = {
    ...
    [3] = {
        label = "Mixed Garden",
        BlipCoord = vector3(1906.65, 4837.29, 46.25),
        Blip = 1,
        BlipColor = 69,
        zones = {
...
ChickenFarm = {
    [1] = {
        label = "Chicken Farm",
        BlipCoord = vector3(2378.2, 5053.26, 46.44),
        Blip = 677,
        BlipColor = 5,
        zones = {
