...
Config.Alerts = {
    ...
    ['fish_progressbar'] = 'Cooking fish',
    ['fish_processing'] = 'You cooked ' ..Config.FishProcessed.. ' fish',
    ['error_fish'] = 'Don\'t have any fish to cook',
